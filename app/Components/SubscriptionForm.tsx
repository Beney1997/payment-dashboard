    ...
    <div className="pt-6 md:py-4 grid md:grid-cols-2 lg:grid-cols-[1fr,_.7fr] items-center">
      <form className="px-4 sm:px-[8%]">
        ...
        <div className="flex flex-wrap mb-3 gap-2">
          {paymentMethods.map((method, index: number) => (
            <button
              ...
              className={`basis-[110px] grow p-2 sm:p-3 w-full border rounded-lg text-left block text-xs sm:text-sm font-medium ${
        ...
        {paymentMethod === "Credit Card" && (
          <div>
            <div className="relative mb-3">
              ...
              />
              <svg
                className="absolute top-[40%] -translate-y-1/2 right-4"
                height="30"
        ...
        <div className="flex gap-4 my-6">
          <button className="bg-gray-200 font-semibold grow max-w-[200px] rounded-md px-4 py-3 text-sm">
            Cancel
          </button>
          <button className="bg-purple-700 text-white grow font-semibold rounded-md px-4 py-3 text-sm">
            Subscribe
          </button>
        </div>
        <p className="text-sm text-gray-500 mb-4 font-medium">
      ...
      <div className="bg-[#f1f5f9] md:rounded-2xl md:mr-4 overflow-hidden">
        <div className="px-4 pt-4 md:px-8 md:pt-8">
          ...
          <div
            ...
            className={`mb-3 cursor-pointer border px-4 py-3 text-base rounded-lg flex items-center gap-2 text-left ${
              plan === "monthly"
                ? "border-purple-500 bg-purple-50"
          ...
          >
            <button
              className={`rounded-full ${
                plan === "monthly"
                  ? "p-1 border-[6px] border-purple-700"
                  : "p-2 border-[2px]"
              }`}
            ></button>
            <div>
              <span className="font-bold">Pay Monthly</span> <br />
              <span className="text-sm text-gray-500 mb-4 font-medium">
                $20 / Month /Member
              </span>
            </div>
          </div>
          <div
            ...
            className={`cursor-pointer border px-4 py-3 text-base rounded-lg flex items-center gap-2 text-left ${
              plan === "annual"
                ? "border-purple-500 bg-purple-50"
                : "border-gray-300 bg-white"
            }`}
          >
            ...
            <span className="inline-block ml-auto bg-purple-700 text-purple-50 text-xs py-1 px-2 rounded-md">
              Save 15%
            </span>
          </div>
          ...
          <p className="text-sm text-gray-500 font-medium flex gap-1">
            ...
            >
              ...
              <path d="M7 11V4h10v7"></path>
            </svg>
            <span>
              Guaranteed to be safe & secure,ensuring that all transcations are
              proctected with the highest level of sercurity.
            </span>
          </p>
          <div>
            <Image
              src={require("@/app/assets/economy-img.jpg")}
              alt="economy avatar"
            />
          </div>
        </div>
